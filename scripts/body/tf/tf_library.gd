...
static func _size_tfs() -> Dictionary:
	return {
		...
		"widen_hips": {
			...
			"blurb": "Broadens the pelvis for a wider, curvier lower body.",
			"staged": false,
			"gate": {"op": "has_tag", "tag": "pelvis"},
			"ops": [{"effect": "prop_delta", "target": {"select": "all_tagged", "tag": "pelvis"},
...
static func _appendage_tfs() -> Dictionary:
	return {
		"add_equine_tail": {
			...
			"ops": [{"effect": "graft_subtree", "target_node": "pelvis", "at": "tail_base",
	...
	return {
		...
		"biped_to_harpy": {
			...
			"ops": [
				...
				{"effect": "graft_subtree", "target_node": "torso_upper", "at": "back_r",
					"subtree": _feathered_wing("wing_r")},
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "leg_l",
					"subtree": _bird_leg("leg_bird_l")},
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "leg_r",
...
static func _biped_pelvis() -> Dictionary:
	return _seg("pelvis", "flesh", "skin", {"length_cm": 25.0}, ["pelvis", "groin", "lower_body"], [
	...
	return {
		"config_wolf_anthro": {
			...
			"ops": [
				...
				{"effect": "graft_subtree", "target_node": "head", "at": "crown_r",
					"subtree": _animal_ear("ear_r", "fur")},
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "tail_base",
		...
		"config_holstaur": {
			...
			"ops": [
				...
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "tail_base",
					"subtree": _seg("tail", "flesh", "fur", {"length_cm": 70.0}, ["tail"], [])},
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "udder_mount",
...
static func _reproductive_tfs() -> Dictionary:
	return {
		...
		"add_penis": {
			...
			"ops": [{"effect": "graft_subtree", "target_node": "pelvis", "at": "genital_mount_c",
		...
		"add_vagina": {
			...
			"ops": [{"effect": "graft_subtree", "target_node": "pelvis", "at": "genital_mount_v",
		...
		"add_teats": {
			...
			"gate": {"op": "has_tag", "tag": "groin"},
			"ops": [
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "belly_l",
					"subtree": _teat("teat_belly_l")},
				{"effect": "graft_subtree", "target_node": "pelvis", "at": "belly_r",
